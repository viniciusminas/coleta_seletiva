...
## 5. Diagrama simplificado (Mermaid)

Diagrama de classes simplificado, cobrindo o domínio e os principais padrões:
...
classDiagram
    ...
    class Entrega {
      ...
      +peso_kg: float
      +limpo: bool
      +triagem_correta: bool
    }

    class PagamentoStrategy {
      <<interface>>
      +calcular(peso_kg: float): float
    }

    class PagamentoPorMaterial
    class PagamentoPapel
    class PagamentoVidro
    class PagamentoMetal
    class PagamentoPlastico

    class CalculadoraPagamento {
      -strategy: PagamentoStrategy
      +calcular_pagamento(peso_kg: float): float
      +trocar_strategy(s: PagamentoStrategy)
    }
    ...
    class BonusVolumeDecorator
    class BonusQualidadeDecorator
    ...
    class Subject {
      ...
      +adicionar_observer(o: Observer)
      +remover_observer(o: Observer)
      +notificar(evento)
    }
    ...
    class PagamentoFactory {
      +criar(material: TipoMaterial): PagamentoStrategy
    }

    PagamentoStrategy <|.. PagamentoPorMaterial
    PagamentoPorMaterial <|-- PagamentoPapel
    PagamentoPorMaterial <|-- PagamentoVidro
    PagamentoPorMaterial <|-- PagamentoMetal
    PagamentoPorMaterial <|-- PagamentoPlastico

    PagamentoComponent <|.. PagamentoBase
    PagamentoComponent <|.. PagamentoDecorator
    PagamentoDecorator <|-- BonusVolumeDecorator
    PagamentoDecorator <|-- BonusQualidadeDecorator
    ...
    Cooperativa --> Config
    PagamentoFactory --> PagamentoStrategy
    Config --> TipoMaterial
```
